#' Generate a data frame overview table
#'
#' @param .data a data frame
#' @param ... other agruments passed to [format_enumeration()],
#'      [format_bars()] or [format_count_percent()]
#' @returns an overview table as a tibble
#' @author Michal Burda
#' @export
